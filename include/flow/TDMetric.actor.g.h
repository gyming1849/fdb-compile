...
#line 1 "/Users/gyming/Documents/USC/CATPS/Task/foundationdb/flow/include/flow/TDMetric.actor.h"
/*
 * TDMetric.actor.h
 *
		...
		while (metrics.size()) {
			...
			if (data.start != 0 && data.rollTime <= rollTime) {
				...
				break;
																...
																#line 636 "/Users/gyming/Documents/USC/CATPS/Task/build/flow/include/flow/TDMetric.actor.g.h"
// This generated class is to be used only via updatePreviousHeader()
															#line 634 "/Users/gyming/Documents/USC/CATPS/Task/foundationdb/flow/include/flow/TDMetric.actor.h"
template <class UpdatePreviousHeaderActor>
															#line 634 "/Users/gyming/Documents/USC/CATPS/Task/foundationdb/flow/include/flow/TDMetric.actor.h"
class UpdatePreviousHeaderActorState {
															#line 642 "/Users/gyming/Documents/USC/CATPS/Task/build/flow/include/flow/TDMetric.actor.g.h"
public:
															#line 634 "/Users/gyming/Documents/USC/CATPS/Task/foundationdb/flow/include/flow/TDMetric.actor.h"
	UpdatePreviousHeaderActorState(FieldLevel* const& self,IMetricDB* const& db,Standalone<MetricKeyRef> const& mk,uint64_t const& rollTime,FDBScope* const& scope) 
		 ...
		 : self(self),
		   ...
		   rollTime(rollTime),
															#line 634 "/Users/gyming/Documents/USC/CATPS/Task/foundationdb/flow/include/flow/TDMetric.actor.h"
		   scope(scope)
															#line 657 "/Users/gyming/Documents/USC/CATPS/Task/build/flow/include/flow/TDMetric.actor.g.h"
	{
	...
	{
		try {
															#line 640 "/Users/gyming/Documents/USC/CATPS/Task/foundationdb/flow/include/flow/TDMetric.actor.h"
			...
			if (static_cast<UpdatePreviousHeaderActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 674 "/Users/gyming/Documents/USC/CATPS/Task/build/flow/include/flow/TDMetric.actor.g.h"
			...
			__when_expr_0.addCallbackAndClear(static_cast<ActorCallback< UpdatePreviousHeaderActor, 0, Optional<Standalone<StringRef>> >*>(static_cast<UpdatePreviousHeaderActor*>(this)));
															#line 679 "/Users/gyming/Documents/USC/CATPS/Task/build/flow/include/flow/TDMetric.actor.g.h"
			loopDepth = 0;
		}
		catch (Error& error) {
	...
	{
															#line 643 "/Users/gyming/Documents/USC/CATPS/Task/foundationdb/flow/include/flow/TDMetric.actor.h"
		if (block.present())
															#line 702 "/Users/gyming/Documents/USC/CATPS/Task/build/flow/include/flow/TDMetric.actor.g.h"
		{
															#line 645 "/Users/gyming/Documents/USC/CATPS/Task/foundationdb/flow/include/flow/TDMetric.actor.h"
			Header oldHeader = calculateHeader(block.get());
															#line 648 "/Users/gyming/Documents/USC/CATPS/Task/foundationdb/flow/include/flow/TDMetric.actor.h"
			self->previousHeader = oldHeader;
															#line 651 "/Users/gyming/Documents/USC/CATPS/Task/foundationdb/flow/include/flow/TDMetric.actor.h"
			self->header.update(oldHeader);
															#line 656 "/Users/gyming/Documents/USC/CATPS/Task/foundationdb/flow/include/flow/TDMetric.actor.h"
			self->lastTimeRequiringHeaderPatch = self->metrics.back().rollTime;
															#line 712 "/Users/gyming/Documents/USC/CATPS/Task/build/flow/include/flow/TDMetric.actor.g.h"
		}
		else
		{
															#line 661 "/Users/gyming/Documents/USC/CATPS/Task/foundationdb/flow/include/flow/TDMetric.actor.h"
			self->previousHeader = Header();
															#line 662 "/Users/gyming/Documents/USC/CATPS/Task/foundationdb/flow/include/flow/TDMetric.actor.h"
			self->lastTimeRequiringHeaderPatch = 0;
															#line 720 "/Users/gyming/Documents/USC/CATPS/Task/build/flow/include/flow/TDMetric.actor.g.h"
		}
															#line 667 "/Users/gyming/Documents/USC/CATPS/Task/foundationdb/flow/include/flow/TDMetric.actor.h"
		MetricBatch batch{ scope };
															#line 668 "/Users/gyming/Documents/USC/CATPS/Task/foundationdb/flow/include/flow/TDMetric.actor.h"
		self->flushUpdates(mk, rollTime, batch);
															#line 670 "/Users/gyming/Documents/USC/CATPS/Task/foundationdb/flow/include/flow/TDMetric.actor.h"
		if (!static_cast<UpdatePreviousHeaderActor*>(this)->SAV<Void>::futures) { (void)(Void()); this->~UpdatePreviousHeaderActorState(); static_cast<UpdatePreviousHeaderActor*>(this)->destroy(); return 0; }
															#line 728 "/Users/gyming/Documents/USC/CATPS/Task/build/flow/include/flow/TDMetric.actor.g.h"
	...
	int a_body1cont1(Optional<Standalone<StringRef>> && block,int loopDepth) 
	{
															#line 643 "/Users/gyming/Documents/USC/CATPS/Task/foundationdb/flow/include/flow/TDMetric.actor.h"
		if (block.present())
															#line 740 "/Users/gyming/Documents/USC/CATPS/Task/build/flow/include/flow/TDMetric.actor.g.h"
		{
															#line 645 "/Users/gyming/Documents/USC/CATPS/Task/foundationdb/flow/include/flow/TDMetric.actor.h"
			Header oldHeader = calculateHeader(block.get());
															#line 648 "/Users/gyming/Documents/USC/CATPS/Task/foundationdb/flow/include/flow/TDMetric.actor.h"
			...
			self->header.update(oldHeader);
															#line 656 "/Users/gyming/Documents/USC/CATPS/Task/foundationdb/flow/include/flow/TDMetric.actor.h"
			self->lastTimeRequiringHeaderPatch = self->metrics.back().rollTime;
															#line 750 "/Users/gyming/Documents/USC/CATPS/Task/build/flow/include/flow/TDMetric.actor.g.h"
		}
		else
		{
															#line 661 "/Users/gyming/Documents/USC/CATPS/Task/foundationdb/flow/include/flow/TDMetric.actor.h"
			self->previousHeader = Header();
															#line 662 "/Users/gyming/Documents/USC/CATPS/Task/foundationdb/flow/include/flow/TDMetric.actor.h"
			self->lastTimeRequiringHeaderPatch = 0;
															#line 758 "/Users/gyming/Documents/USC/CATPS/Task/build/flow/include/flow/TDMetric.actor.g.h"
		}
															#line 667 "/Users/gyming/Documents/USC/CATPS/Task/foundationdb/flow/include/flow/TDMetric.actor.h"
		MetricBatch batch{ scope };
															#line 668 "/Users/gyming/Documents/USC/CATPS/Task/foundationdb/flow/include/flow/TDMetric.actor.h"
		self->flushUpdates(mk, rollTime, batch);
															#line 670 "/Users/gyming/Documents/USC/CATPS/Task/foundationdb/flow/include/flow/TDMetric.actor.h"
		if (!static_cast<UpdatePreviousHeaderActor*>(this)->SAV<Void>::futures) { (void)(Void()); this->~UpdatePreviousHeaderActorState(); static_cast<UpdatePreviousHeaderActor*>(this)->destroy(); return 0; }
															#line 766 "/Users/gyming/Documents/USC/CATPS/Task/build/flow/include/flow/TDMetric.actor.g.h"
		new (&static_cast<UpdatePreviousHeaderActor*>(this)->SAV< Void >::value()) Void(Void());
		this->~UpdatePreviousHeaderActorState();
		static_cast<UpdatePreviousHeaderActor*>(this)->finishSendAndDelPromiseRef();
		return 0;
	...
	void a_callback_fire(ActorCallback< UpdatePreviousHeaderActor, 0, Optional<Standalone<StringRef>> >*,Optional<Standalone<StringRef>> const& value) 
	{
		...
		ActorExecutionContextHelper __helper(static_cast<UpdatePreviousHeaderActor*>(this)->activeActorHelper.actorID, __identifier);
		#endif // WITH_ACAC
		a_exitChoose1();
		try {
	...
	uint64_t rollTime;
															#line 634 "/Users/gyming/Documents/USC/CATPS/Task/foundationdb/flow/include/flow/TDMetric.actor.h"
	FDBScope* scope;
															#line 859 "/Users/gyming/Documents/USC/CATPS/Task/build/flow/include/flow/TDMetric.actor.g.h"
};
// This generated class is to be used only via updatePreviousHeader()
															#line 634 "/Users/gyming/Documents/USC/CATPS/Task/foundationdb/flow/include/flow/TDMetric.actor.h"
class UpdatePreviousHeaderActor final : public Actor<Void>, public ActorCallback< UpdatePreviousHeaderActor, 0, Optional<Standalone<StringRef>> >, public FastAllocated<UpdatePreviousHeaderActor>, public UpdatePreviousHeaderActorState<UpdatePreviousHeaderActor> {
															#line 864 "/Users/gyming/Documents/USC/CATPS/Task/build/flow/include/flow/TDMetric.actor.g.h"
public:
	using FastAllocated<UpdatePreviousHeaderActor>::operator new;
	using FastAllocated<UpdatePreviousHeaderActor>::operator delete;
	static constexpr ActorIdentifier __actorIdentifier = UID(10537772089289336576UL, 12364641316854618112UL);
...
friend struct ActorCallback< UpdatePreviousHeaderActor, 0, Optional<Standalone<StringRef>> >;
	...
	UpdatePreviousHeaderActor(FieldLevel* const& self,IMetricDB* const& db,Standalone<MetricKeyRef> const& mk,uint64_t const& rollTime,FDBScope* const& scope) 
															#line 881 "/Users/gyming/Documents/USC/CATPS/Task/build/flow/include/flow/TDMetric.actor.g.h"
		 : Actor<Void>(),
		   ...
		   activeActorHelper(__actorIdentifier)
	{
		...
		#ifdef WITH_ACAC
		static constexpr ActorBlockIdentifier __identifier = UID(6429733112498419456UL, 12580013061421694208UL);
		ActorExecutionContextHelper __helper(static_cast<UpdatePreviousHeaderActor*>(this)->activeActorHelper.actorID, __identifier);
		#endif // WITH_ACAC
...
[[nodiscard]] static Future<Void> updatePreviousHeader( FieldLevel* const& self, IMetricDB* const& db, Standalone<MetricKeyRef> const& mk, uint64_t const& rollTime, FDBScope* const& scope ) {
	...
	return Future<Void>(new UpdatePreviousHeaderActor(self, db, mk, rollTime, scope));
															#line 913 "/Users/gyming/Documents/USC/CATPS/Task/build/flow/include/flow/TDMetric.actor.g.h"
}

#line 672 "/Users/gyming/Documents/USC/CATPS/Task/foundationdb/flow/include/flow/TDMetric.actor.h"
